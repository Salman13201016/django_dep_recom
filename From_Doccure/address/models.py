...
class address_name(models.Model):
    ...
    division_fk = models.ForeignKey(Division_Name, on_delete=models.CASCADE,null=True, blank=True)
    district_fk = models.ForeignKey(District_Name, on_delete=models.CASCADE,null=True, blank=True)
    station_fk = models.ForeignKey(Station, on_delete=models.CASCADE,null=True, blank=True)
    hos_type_fk = models.ForeignKey(hospital_categories, on_delete=models.CASCADE,null=True, blank=True)
